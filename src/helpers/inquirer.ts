...
const menuOpts = [
  {
    ...
    choices: [
      ...
      { value: "2", name: `${"2.".red} Listar tarea(s)` },
      { value: "3", name: `${"3.".red} Listar tarea(s) completada(s)` },
      { value: "4", name: `${"4.".red} Listar tarea(s) incompleta(s)` },
      { value: "5", name: `${"5.".red} Completar tarea(s)` },
      { value: "6", name: `${"6.".red} Borrar tarea(s)` },
  ...
  const preguntas = [
    {
      ...
      message: "Seleccione la(s) tarea(s) a borrar:",
      choices
    }
  ];
